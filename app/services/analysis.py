...
3. Также ОБЯЗАТЕЛЬНО добавь ключи "summary" (краткое резюме запроса в 2-3 предложениях), "title" (короткое название проекта в 2-4 слова), "keywords" (массив из 3-5 ключевых слов).
4. Если информация не была озвучена клиентом — поставь пустую строку "" для текстовых полей, а название обязательного поля (например, "{template.sections[0].title}") добавь в массив "missing_fields". Не выдумывай данные.
5. Для поля "missing_info" — сформулируй 1-3 вопроса клиенту для уточнения деталей. Оставь поле пустым, если вопросов нет.
...
{{
  ...
  "keywords": ["сайт", "визитка", "стоматология", "запись"],
  "service_type": "Разработка сайта-визитки",
  "deadline": "2 недели",
  "budget": "50 000 руб.",
  "wishes": "1. Минималистичный дизайн\\n2. Адаптивная верстка",
  "missing_fields": ["Домен", "Готовый контент"],
